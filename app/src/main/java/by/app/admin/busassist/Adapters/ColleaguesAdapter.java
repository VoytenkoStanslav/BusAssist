...
import by.app.admin.busassist.Update.ColleaguesUpdateValue;
...
public class ColleaguesAdapter extends RecyclerView.Adapter<ColleaguesAdapter.ViewHolder>{
    ...
    public ColleaguesAdapter(List<Colleagues> myDataset, FragmentActivity context, RecyclerView recyclerView) {
        mColleagList = myDataset;
        mContext = context;
        mRVColleag = recyclerView;
    }

    public ColleaguesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        LayoutInflater inflater = LayoutInflater.from(
                parent.getContext());
        View v = inflater.inflate(R.layout.single_row_colleagues, parent, false);
        ColleaguesAdapter.ViewHolder vh = new ColleaguesAdapter.ViewHolder(v);
        return vh;
    }

    public void onBindViewHolder(ColleaguesAdapter.ViewHolder holder, final int position) {
        ...
        new LoadImageTask(holder.imageViewColl).execute(position);
            ...
            public void onClick(View v) {
                ...
                builder.setNeutralButton("Удалить", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dbHelper.deleteColleag(colleagues.getId_colleag(), mContext);
    ...
    private void goToUpdateActivity(long colleagId) {
        Intent goToUpdate = new Intent(mContext, ColleaguesUpdateValue.class);
        goToUpdate.putExtra("COLLEAGUES_ID", colleagId);
        Log.e("LLLOOOGGG", String.valueOf(colleagId));
